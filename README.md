...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3smeiks.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3smeiks.containers.anotherwebservice.com/
...
```
git clone git@github.com:Kavindu-Deshapriya/container-3smeiks.git
```
...
```
docker attach container-3smeiks
```
